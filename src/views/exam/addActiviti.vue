<template>
    <div class="centoer">
                 ...
                 <div class="nei">
                     <div class="ovh">
                         <div class="mgt10 ww60">
                             <span class="db w100 fl h40 lh40 cor0 pdl7">活动名称:</span>
                             <div class="mgl100">
                     ...
                     <div class="ovh">
                         <div class="mgt10 ww60">
                             <span class="db w100 fl h40 lh40 cor0 pdl7">活动分类:</span>
                             <div class="mgl100">
                     ...
                     <div class="ovh">
                         <div class="mgt10 ww50">
                             <span class="db w100 fl h40 lh40 cor0 pdl7">活动试卷:</span>
                             <div class="mgl100">
                     ...
                     <template v-if="insertExam.examType!=0">
                         <div class="ovh">
                             <div class="mgt10 ww50">
                                 <span class="db w100 fl h40 lh40 cor0 pdl7">答题次数:</span>
                                 <div class="mgl100">
                                     <el-radio :disabled="dis" v-model="radio" :label=0 style="line-height: 35px">无限次</el-radio>
                                     <el-radio :disabled="dis" v-model="radio" :label=1 style="line-height: 35px">有限次</el-radio>
                                     <template v-if="radio==1">
                                         <input :disabled="dis"  v-model="insertExam.answersNumber" type="text" class="ww7 h38 lh40 pdl20 borf1 ras4" placeholder="次">
                                     </template>
                                 </div>
                             </div>
                         </div>
                     ...
                     <div class="ovh">
                         <div class="mgt10 ww50">
                             <span class="db w100 fl h40 lh40 cor0 pdl7">活动时长:</span>
                             <div class="mgl100">
                                 <el-radio v-model="radio2" :label=0 style="line-height: 35px">不限时长</el-radio>
                                 <el-radio v-model="radio2" :label=1 style="line-height: 35px">限制时长</el-radio>
                                 <input  v-if="radio2==1" v-model="insertExam.examTime" type="text" class="ww7 h36 lh40 pdl20 borf1 ras4" placeholder="分钟">
                             </div>
                         </div>
                     </div>
                     <template v-if="insertExam.examType!=0">
                         <div class="ovh">
                             <div class="mgt10 ww50">
                                 <span class="db w100 fl h40 lh40 cor0 pdl7">及格分数:</span>
                                 <div class="mgl100">
                                     <template v-if="insertExam.examType==0">
                     ...
                     <template v-if="insertExam.examType!=0">
                         <div class="ovh">
                             <div class="mgt10 ww50">
                                 <span class="db w100 fl h40 lh40 cor0 pdl7">回看设置:</span>
                                 <div class="mgl100">
                                     <template v-if="insertExam.examType==0">
                                         <el-radio disabled v-model="insertExam.echoSetting" :label=0 style="line-height: 35px">显示正确答案</el-radio>
                                         <el-radio disabled v-model="insertExam.echoSetting" :label=1 style="line-height: 35px">不显示正确答案</el-radio>
                                     </template>
                                     <template v-else>
                                         <el-radio  v-model="insertExam.echoSetting" :label=0 style="line-height: 35px">显示正确答案</el-radio>
                                         <el-radio  v-model="insertExam.echoSetting" :label=1 style="line-height: 35px">不显示正确答案</el-radio>
                                     </template>
                     ...
                     <div class="ovh">
                         <div class="mgt10 ww50">
                             <span class="db w100 fl h40 lh40 cor0 pdl7">活动生效时间:</span>
                             <div class="mgl100">
                     ...
                     <div class="ovh">
                         <div class="mgt10 ww50">
                             <span class="db w100 fl h40 lh40 cor0 pdl7">活动失效时间:</span>
                             <div class="mgl100">
                     ...
                     <div class="ovh">
                         <div class="mgt10 ww50">
                             <span class="db w100 fl h100 lh40 cor0 pdl7">活动说明:</span>
                             <div class="mgl100">
       ...
       <div v-show="frameShow" class="point" style="display: none;" >
             <div class="tan6 abs bgw k3 db" style="margin-left: 17%;margin-top:5%;width: 65%;height: 70%">
                ...
                <div class="mgt50 k3">
                    <table class="table5 t-c" style="width: 100%;height: 100%">
                        <thead>
                        <tr>
