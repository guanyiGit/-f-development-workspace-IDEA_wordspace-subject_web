                 ...
                 <div class="nei">
                     ...
                     <div class="ovh">
                      ...
                      <div class="ovh">
                          <div class="mgt10 ww50">
                              ...
                              <div class="mgl100">
                                  <el-radio disabled v-model="radio" :label=0 style="line-height: 35px">不限次</el-radio>
                                  <el-radio disabled v-model="radio" :label=1 style="line-height: 35px">有限次</el-radio>
                                  <input disabled v-if="radio==1" v-model="data.answersNumber" type="text" class="ww7 h38 lh40 pdl20 borf1 ras4" >
                              </div>
                          </div>
                      </div>
                     <div class="ovh">
                          <div class="mgt10 ww50">
                              ...
                              <div class="mgl100">
                                  <el-radio disabled v-model="radio2" :label=0 style="line-height: 35px">不限时长</el-radio>
                                  <el-radio disabled v-model="radio2" :label=1 style="line-height: 35px">限制时长</el-radio>
                                  <input disabled v-if="radio2==1" v-model="data.examTime" type="text" class="ww7 h40 lh38 pdl20 borf1 ras4" placeholder="分钟">
                              </div>
                          </div>
                      </div>
                      <div class="ovh">
                     ...
                     <div class="ovh">
                       <div class="mgt10 ww50">
                           ...
                           <div class="mgl100">
                               <el-radio  v-model="data.echoSetting" :label=0 disabled style="line-height: 35px">显示正确答案</el-radio>
                               <el-radio v-model="data.echoSetting" :label=1 disabled style="line-height: 35px">不显示正确答案</el-radio>
                           </div>
                       </div>
                   </div>
                     <div class="ovh">
